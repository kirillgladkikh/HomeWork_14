...
Проект "Домашнее задание 16.2" - это код на Python покрытый тестами.
Работа над магазином: оптимизируем работу с родительскими классами путем создания абстрактных классов и классов наследников.
